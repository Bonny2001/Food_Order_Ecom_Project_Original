...
<footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto ">
  ...
  <div className="text-center">
    <div>
      <a className="flex-none text-xl font-semibold text-black text-white" href="#" aria-label="Brand">FOODIFY</a>
    </div>
    {/* <!-- End Col --> */}

    <div className="mt-3">
      <p className="text-gray-500 dark:text-neutral-500">Designed By Arkaprava Adhikary 
        {/* <a className="text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500" href="#">Htmlstream</a> 
        family. */}
        </p>
      <p className="text-gray-500 dark:text-neutral-500">
        © 2025 Food Delvery Webside on React JS.
      </p>
    </div>
